    ...
    return (
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="inline-flex items-center rounded-full border border-slate-300 bg-white px-3.5 py-1.5 text-sm text-slate-700 shadow-sm hover:bg-slate-50 active:scale-[.98] transition"
        >
          Salir
        </button>
      </div>
