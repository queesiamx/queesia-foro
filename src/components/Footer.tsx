...
export default function Footer() {
  return (
    <footer
      className="fixed bottom-0 inset-x-0 z-50 border-t bg-white/80 backdrop-blur
                 supports-[backdrop-filter]:bg-white/60 dark:bg-slate-900/80"
      ...
      <div className="mx-auto max-w-7xl px-4 h-full flex items-center justify-between gap-4">
        ...
        <div className="flex gap-4 items-center">
          ...
          <a
            ...
            className="text-slate-700 hover:text-pink-500 dark:text-slate-200 transition"
            title="Instagram"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-slate-700 hover:text-blue-600 dark:text-slate-200 transition"
            title="Facebook"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-slate-700 hover:text-purple-500 dark:text-slate-200 transition"
            title="Threads"
          >
            <svg
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-slate-700 hover:text-black dark:text-slate-200 transition"
            title="TikTok"
          >
            <svg
              viewBox="0 0 256 256"
          ...
          {/* X / Twitter (SVG mínima, evita react-icons) */}
          <a
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-slate-700 hover:text-red-600 dark:text-slate-200 transition"
            title="YouTube"
          >
            <svg
              viewBox="0 0 24 24"
        ...
        {/* Legales */}
        <div className="hidden sm:flex flex-wrap gap-4 justify-end text-xs sm:text-sm">
          <a href="/terminos" className="text-slate-700 hover:underline dark:text-slate-200">
            Términos y Condiciones
          </a>
          <a href="/privacidad" className="text-slate-700 hover:underline dark:text-slate-200">
            Aviso de Privacidad
          </a>
        </div>
      </div>
